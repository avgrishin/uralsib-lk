        ...
        template(v-if="!webview")
            ...
            p Это означает, что 
                ul
                    ...
                    li стоимость пая уменьшается в 100 раз, что позволит совершать любые операции с паями #[b с небольшими суммами];#[br]
                    li все заявки принимаются #[b в стандартном режиме].#[br]
            p #[b ВАЖНО!]
            ul
                li объем активов в паях #[b не меняется];#[br]
                li срок владения паями, а также имущественные права и обязанности #[b не меняются];#[br]
            p Обновленная информация по стоимости паев будет доступна на сайте АО «УК УРАЛСИБ» #[b 7 июня].
            p
                small 
                    i #[sup *]Сообщение о принятии решения о дроблении инвестиционных паев 20.05.2021 было раскрыто на сайте Управляющей компании в установленном действующим законодательством порядке. Возможность дробления паёв предусмотрена действующим законодательством о паевых инвестиционных фондах.
