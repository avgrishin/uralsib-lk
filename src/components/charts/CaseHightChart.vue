<template lang="pug">
    #chartdiv.chartdiv(style="border-bottom: 1px solid #123d77; border-top: 1px solid #123d77; padding-bottom: 1px;" ref="chartdiv")
</template>
<script>
    ...
    export default {
        ...
        methods: {
            ...
            generateChart() {
                ...
                this.chart = Highcharts.stockChart('chartdiv', {
